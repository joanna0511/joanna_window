...
from plot_methods import plot_kd_chart, plot_ma_chart, plot_volume_chart, plot_normal_distribution, plot_boxplot
...
class StockApp:
    def __init__(self, root):
        ...
        self.chart_options = ["KD指標圖", "均價指標圖", "均量指標圖", "常態分佈圖", "盒鬚圖"]  # 添加新選項
    ...
    def plot_chart(self, initial=False):
        ...
        if ticker:
            ...
            start_date = end_date - timedelta(days=365)  # 最近1年的數據
            try:
